...
def merge_kinematic_video():
	fwx = open("/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_kinematics_video_feature_20_X.txt", "w")
	fwy = open("/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_kinematics_video_feature_20_y.txt", "w")
	count = 0
	# sample_rate = 20
	prev_label = "0"
	kindata = {}
	...
	frameids = []
	with open("/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/frameid_sorted_nodiff_all_20.txt") as f:
		for line in f:
			line = line.strip()
			line = line.replace("\n", "")
			line = line.replace("\r", "")
	...
	features = np.loadtxt("/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/features_sorted_nodiff_all_20.cnn", delimiter=' ')
...
def merge_unify_kin_video(video=True, kin=True):
	A = np.loadtxt("/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_kinematics_video_feature_20_X.txt", delimiter = ' ')
	...
	if video == True and kin == True:
		...
		print(A_new.shape)
		np.savetxt('/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_kinematics_video_feature_20_X_unify.txt', A_new, delimiter=' ')
	elif video == False and kin == True:
		A_new = np.concatenate((A1, A2), axis = 1)
		print(A_new.shape)
		np.savetxt('/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_kinematics_only_feature_20_X_unify.txt', A_new, delimiter=' ')
	elif video == True and kin == False:
		A_new = A3
		print(A_new.shape)
		np.savetxt('/scratch/gilbreth/rahman64/dataset/surgeme/Taurus/taurus_video_only_feature_20_X_unify.txt', A_new, delimiter=' ')
